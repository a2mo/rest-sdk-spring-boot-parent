/*
package com.tosan.springboot.httpclient.impl.proxy;

import com.tosan.springboot.httpclient.HttpClientProperties;
...
public class ConfigurableProxySelectorTest {
    ...
    private static final String MATCHING_HOST_PATTERN = "proxy.tosan.com";
    private static final String NON_MATCHING_HOST_PATTERN = "nonmatch.com";

    private static final String MATCHING_URI = "http://proxy.tosan.com/example";
    private static final String NON_MATCHING_URI = "http://tosan.com/example";

    private static final HttpClientProperties.ProxyConfiguration NO_PATTERN_CONFIG =
            getHostConfiguration("localhost-nopattern", 1337);
    private static final HttpClientProperties.ProxyConfiguration WILDCARD_CONFIG =
            getHostConfiguration("localhost-wildcard", 1337, WILDCARD_HOST_PATTERN);
    private static final HttpClientProperties.ProxyConfiguration MATCHING_CONFIG =
            getHostConfiguration("localhost", 3128, MATCHING_HOST_PATTERN);
    private static final HttpClientProperties.ProxyConfiguration NON_MATCHING_CONFIG =
            getHostConfiguration("localhost-non-matching", 1337, NON_MATCHING_HOST_PATTERN);
    private static final HttpClientProperties.ProxyConfiguration MULTI_HOSTPATTERN_CONFIG =
            getHostConfiguration("localhost", 3128, MATCHING_HOST_PATTERN, "tosan.org");
    ...
    private static final Proxy WILDCARD_PROXY = new Proxy(Proxy.Type.HTTP,
            new InetSocketAddress(WILDCARD_CONFIG.getProxyHost(), WILDCARD_CONFIG.getProxyPort()));
    private static final Proxy MATCHING_PROXY = new Proxy(Proxy.Type.HTTP,
            new InetSocketAddress(MATCHING_CONFIG.getProxyHost(), MATCHING_CONFIG.getProxyPort()));
 ...
 *//*
    ...
    public void select_singleMatching_multiplePattern() throws URISyntaxException {
        ...
        uri = new URI("http://proxy.tosan.com/example");
